...
В текущем fork нет отдельного скринкаста или публичного демо.

Если нужно быстро показать основные пользовательские сценарии, достаточно прогнать:

- регистрация
- авторизация
- восстановление пароля
- успешный вход на `/dashboard`
